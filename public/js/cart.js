...
const addItemToCart = async (quantity, product) => {
  try {
    const response = await fetch(`/apis/cart`, {
      method: "POST",
      body: JSON.stringify({
        quantity,
        product : +product,
...
const removeItemToCart = async (id) => {
  try {
    ...
    const response = await fetch(`/apis/cart?product=${id}`, {
      method : 'DELETE'
    });
...
const deleteItemToCart = async (id) => {
  try {
    ...
    const response = await fetch(`/apis/cart/item?product=${id}`, {
      method : 'DELETE'
    });
...
const clearCart = async () => {
  try {
    ...
    const response = await fetch(`/apis/cart/all`,{
      method : 'DELETE'
    });
